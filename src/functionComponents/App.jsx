  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="/technology"
          element={<Home search={search} language={language} q="Technology" />}
        />
        <Route
          path="/sports"
        ...
        <Route
          path="/olympics"
          element={<Home search={search} language={language} q="Olympics" />}
        />
        <Route
          path="/economics"
        ...
        <Route
          path="/wealth"
          element={<Home search={search} language={language} q="Wealth" />}
        />
        <Route
          path="/world"
